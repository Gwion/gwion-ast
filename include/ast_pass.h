...
#define DECL_PRIM_FUNC(prefix, type, arg, mod)                                   \
  typedef type (*_##prefix##_prim_func)(arg, mod union prim_data *);             \
...
#define DECL_EXP_FUNC(prefix, type, arg, mod)                                    \
  typedef type (*_##prefix##_exp_func)(const arg, mod union exp_data *);         \
...
#define DECL_SECTION_FUNC(prefix, type, arg, mod)                                \
  typedef type (*_##prefix##_section_func)(const arg, mod union section_data *); \
